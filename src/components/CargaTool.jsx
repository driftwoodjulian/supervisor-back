...
const CargaTool = ({ user }) => {
  ...
  const handleQuery = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}${import.meta.env.VITE_CARGA_ENDPOINT}`, {
        method: "POST",
        headers: {
  ...
  return (
    <div className="tool-section">
      <h3 className="text-white mb-4">CARGA Tool</h3>
